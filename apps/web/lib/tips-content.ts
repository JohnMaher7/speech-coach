...
export const TIPS_SECTIONS: TipsSection[] = [
  {
    ...
    intro:
      "Most speaking advice is noise. These six fundamentals survive scrutiny, and they apply whether you're toasting a wedding or pitching a board.",
    tips: [
      {
        heading: "Start with the audience, not your material",
        body: "The single biggest shift in speaking skill is moving from “here's what I want to say” to “what does this audience need to hear?” Before you write a word, answer three questions: who are they, what do they already know, and what should they do differently afterwards. Every choice about content, length, and language follows from that.",
      ...
      },
      {
        ...
        body: "Audiences follow and recall talks that have a recognizable shape: a beginning that frames, a middle with a few clear points, and an end that resolves. Memorize the map, not the script. Know your opening and closing cold, and navigate the middle from structure rather than from memorized prose.",
      },
      {
        heading: "Always practice out loud",
  ...
  },
  {
    ...
    intro:
      "Delivery is the part of speaking you can measure, which makes it the part you can train. These are the mechanics behind a confident-sounding talk.",
    tips: [
      {
      ...
      },
      {
        ...
        body: "Under pressure, speakers trail off, swallow final words, or let endings dissolve into “so, yeah.” The end of a sentence is where the meaning lands, so give it full volume and a full stop. Strong endings, sentence by sentence, are what “sounding sure of yourself” is actually made of.",
      },
    ],
  },
  {
    ...
    tips: [
      ...
      },
      {
        ...
        body: "Memory research is consistent: people retain narratives far better than disconnected facts, because a story gives each detail a place in a causal chain. Wherever you have a point to make, ask whether there's a person, a scene, or a before-and-after that carries it. One concrete story beats three abstract arguments.",
      },
      {
        heading: "Use the rule of three",
        body: "Audiences absorb and recall groups of three more easily than longer lists: three points, three examples, three-beat phrases. Rhetoric has leaned on this from Aristotle to “blood, sweat and tears.” If you have five points, you have two speeches or one bloated one. Cut or merge until three remain.",
      },
      {
    ...
    tips: [
      {
        ...
        body: "The difference between rambling and a sharp impromptu answer is rarely intelligence. The sharp answer simply has a skeleton. PREP is the workhorse: make your Point, give the Reason, share an Example, restate the Point. The structure does the organizing so you can spend your attention on what you're actually saying.",
        attribution: "Matt Abrahams · Stanford Graduate School of Business",
      },
      {
        heading: "What? So what? Now what?",
        body: "For reflections, updates, and feedback, this three-beat frame is hard to beat: what happened, why it matters to this audience, and what should happen next. It forces relevance, which is exactly what unprepared answers usually lack.",
        attribution: "Matt Abrahams · Stanford Graduate School of Business",
      },
      {
      ...
      },
      {
        ...
        body: "Impromptu answers rarely fail at the start. They fail at the end, dissolving into “so… yeah.” Decide you will end with one declarative sentence, even if it's just restating your point. A clean final sentence retroactively makes the whole answer sound planned.",
      },
    ],
  },
  {
    ...
    tips: [
      ...
      },
      {
        ...
        body: "If text is too small to read from the worst seat, it shouldn't be on the slide. Big type also enforces discipline: you physically can't fit a paragraph at 30-point. If a slide needs a paragraph, it's really a document. Send it afterwards.",
      },
      {
      ...
      },
      {
        ...
        body: "Every unfamiliar element is a place for the talk to wobble: the clicker, the screen, the room, your laptop on the venue's projector. Arrive early, run the first two minutes in the actual room if you can, and have a fallback (a PDF on a USB stick) for when the tech fails. It eventually will.",
      },
    ],
  },
  {
    ...
    summary:
      "Camera, audio, and energy: the mechanics of being compelling through a screen.",
    intro:
    ...
    tips: [
      ...
      {
        heading: "Audio beats video, so invest accordingly",
      ...
      },
      {
        ...
        body: "Sitting with a bright window behind you turns you into a silhouette. Face the window instead, or put a soft light behind your camera. Online, your face does the work your body language did in the room, so the audience has to be able to see it.",
      },
      {
        heading: "Turn the energy up a notch",
        body: "Cameras and compression flatten you: voices lose range, gestures shrink, and what felt expressive in the room arrives as monotone. Compensate deliberately with more vocal variety than feels natural and visible gestures inside the frame, and stand up if you can. Slightly too animated on camera reads as exactly right.",
      },
      {
    ...
    tips: [
      {
        ...
        body: "The famous 7–38–55 split comes from 1960s experiments on single spoken words where tone and meaning deliberately conflicted, which is nothing like a speech. Mehrabian himself has spent decades asking people to stop generalizing it. Words carry your content; delivery shapes how it lands. Neither is 93% of anything.",
        attribution: "Albert Mehrabian, on the misuse of his own 1967 studies",
      },
      {
        heading: "“Do a power pose before you go on”",
        body: "The 2010 study behind power posing failed to replicate in larger follow-ups, and one of its own authors publicly disavowed the effect. Standing tall is fine, since posture affects how the audience sees you, but two minutes in a Wonder Woman stance won't change your hormones or your outcome. Preparation and repeated exposure will.",
